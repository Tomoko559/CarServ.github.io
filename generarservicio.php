...
<head>
    <meta charset="utf-8">
    <title>Taller Mecánico CarServ/Generar Servicio</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="generarservicio.php" class="nav-item nav-link active">Generar Servicio</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Servicios</a>
                    <div class="dropdown-menu fade-up m-0">
                        <a href="service.php" class="dropdown-item" class="nav-item nav-link">Mecánica</a>
                        <a href="service.php" class="dropdown-item" class="nav-item nav-link">Hojalatería y Pintura Automotriz</a>
                        <a href="service.php" class="dropdown-item"class="nav-item nav-link">Electricidad Automotriz</a>
                        <a href="service.php" class="dropdown-item" class="nav-item nav-link">Escáner</a>
                        <a href="service.php" class="dropdown-item" class="nav-item nav-link">Estética Automotriz</a>
                        <a href="service.php" class="dropdown-item" class="nav-item nav-link">Venta y Montaje de Llantas</a>
                    </div>
                </div>
            </div>
            <a href="Login/Index.php" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Iniciar Sesión<i
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Generar Servicio</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="service.html">Servicios</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Generar Servicios</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase">// Genera el Servicio que Solicita //</h6>
